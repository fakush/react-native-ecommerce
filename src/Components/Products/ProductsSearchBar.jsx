...
const ProductsSearchBar = ({ onSearch, error = "", goBack }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <IconButton icon='close-circle' color={'black'} onPress={() => setSearch("")} />
            {error && <DefaultModal title='Error' body={error} modalVisible={modalVisible} onClose={onCloseError} /> }
        </View>
    )
}
